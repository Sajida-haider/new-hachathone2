// Cartsidebar.tsx or Sidebar.tsx
"use client";

import Image from "next/image";

// Type definition for Cartsidebar props
...
const Cartsidebar = ({ isOpen, onClose }: CartsidebarProps) => {
  if (!isOpen) return null; // Do not render if sidebar is closed

  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black bg-opacity-50 transition-all duration-300 ease-in-out">
